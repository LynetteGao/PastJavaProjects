...
//      ); 
      ...
      TextArea text = new TextArea("i made it!");
      root.setRight(text);
      // setTop
      ...
      bottomButton.setOnAction(e->text.clear());
  ...
  public static void main(String[] args) {
    Stream.iterate(10,x->x*3).limit(3).forEach(number->System.out.println(number));
    Application.launch(args);
//    int product = IntStream.range(1,4).reduce(1,(a,b)->a*b);
